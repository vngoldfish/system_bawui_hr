...
import IdLookupPanel from '@/components/common/IdLookupPanel';
...
export default function EmployeeImportModal({ isOpen, onClose, onSuccess }: EmployeeImportModalProps) {
  ...
  const templateJson = JSON.stringify([
    {
      ...
      "firstNameKana": "ケンジ",
      "lastNameKana": "スズキ",
      "email": "kenji.suzuki@bawui.com",
      "phone": "090-1234-5678",
      "birthDate": "1990-05-15",
      "departmentId": "cui-department-id-here",
      "positionId": "cui-position-id-here",
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 backdrop-blur-md bg-slate-900/60 animate-fadeIn">
      <div className={`bg-white dark:bg-slate-900 p-6 md:p-8 rounded-3xl shadow-2xl w-full border border-slate-150/80 dark:border-slate-800 flex flex-col max-h-[90vh] animate-scaleUp transition-all duration-300 ${
