...
export function proxy(request: NextRequest) {
  ...
  if (
    ...
    (pathname === '/api/company' && request.method === 'GET')
  ) {
  ...
  try {
    ...
    const guards: Record<string, string> = {
      ...
      '/api/shifts': 'attendance:view',
      '/api/shift-availability': 'attendance:view',
      '/api/schedule-overview': 'attendance:view',
      '/api/holidays/import': 'settings:view',
      '/leave': 'leave:view',
      ...
      '/api/dispatch-report': 'payroll:view',
